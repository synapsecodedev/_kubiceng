...
// ===== DASHBOARD & ALERTS =====
export const getDashboardKpis = (projectId?: string) => 
  api.get<DashboardKpis>('/dashboard/kpis', { params: { projectId } }).then(r => r.data);

export const getAlertas = (projectId?: string) => 
  api.get<Alerta[]>('/alertas', { params: { projectId } }).then(r => r.data);
...
// ===== EXECUÇÃO =====
export const getRdos = (projectId?: string) => api.get<Rdo[]>('/rdos', { params: { projectId } }).then(r => r.data);
export const createRdo = (data: Omit<Rdo, 'id'>) => api.post<Rdo>('/rdos', data).then(r => r.data);
export const getFvs = (projectId?: string) => api.get<FichaVerificacao[]>('/fvs', { params: { projectId } }).then(r => r.data);
...
export const getEstoque = (projectId?: string) => api.get<ItemEstoque[]>('/estoque', { params: { projectId } }).then(r => r.data);
...
// ===== FINANCEIRO =====
export const getContasPagar = (projectId?: string) => api.get<ContaPagar[]>('/contas-pagar', { params: { projectId } }).then(r => r.data);
...
export const getMedicoes = (projectId?: string) => api.get<Medicao[]>('/medicoes', { params: { projectId } }).then(r => r.data);
...
export const getFluxoCaixa = (projectId?: string) => api.get<FluxoCaixa[]>('/fluxo-caixa', { params: { projectId } }).then(r => r.data);

// ===== PESSOAS =====

// ===== PESSOAS =====
export const getFuncionarios = (projectId?: string) => api.get<Funcionario[]>('/funcionarios', { params: { projectId } }).then(r => r.data);
...
export const getPonto = (data?: string, projectId?: string) => api.get<RegistroPonto[]>('/ponto', { params: { data, projectId } }).then(r => r.data);
export const createRegistroPonto = (data: Omit<RegistroPonto, 'id'>) => api.post<RegistroPonto>('/ponto', data).then(r => r.data);

// ===== SUPRIMENTOS =====
export const getRequisicoes = (projectId?: string) => api.get<Requisicao[]>('/requisicoes', { params: { projectId } }).then(r => r.data);
...
export const getOrdens = (projectId?: string) => api.get<OrdemCompra[]>('/ordens-compra', { params: { projectId } }).then(r => r.data);
...
// ===== COMERCIAL =====
export const getClientes = (projectId?: string) => api.get<Cliente[]>('/clientes', { params: { projectId } }).then(r => r.data);
...
export const getChamados = (projectId?: string) => api.get<Chamado[]>('/chamados', { params: { projectId } }).then(r => r.data);
